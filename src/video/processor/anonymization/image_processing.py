...
from app.models.research.object_detection.utils import ops as utils_ops
...
# Settings appropriate for Carlota's cameras
...
class Img():
    def __init__(self, np_image):
        self.image_np = np.asarray(np_image)
    ...
    # Perform blur of bounding boxes
    def blurring(self):
